                                        ...
                                        <% if (errorMessage !=null) { %>
                                            ...
                                            <% } %>
                                                ...
                                                <div class="page-header">
                                                    ...
                                                    <div class="page-subtitle">Tạo và quản lý hóa đơn của khách</div>
                                                </div>
                                                ...
                                                <div class="grid-4 mb-4">
                                                    <div class="stat-card">
                                                        ...
                                                        <div class="stat-label">
                                                            <i class="bi bi-receipt"></i> Tổng số hóa đơn
                                                        </div>
                                                    </div>
                                                    <div class="stat-card">
                                                ...
                                                <% if (PermissionUtil.hasPermission(session, "payments.create" )) { %>
                                                ...
                                                <div class="card-modern">
                                                    <h5 class="mb-4">
                                                        <i class="bi bi-list-check"></i> Hóa đơn gần đây
                                                    </h5>
                                                    <div class="grid-3">
                                                        <% if (invoices !=null && !invoices.isEmpty()) { for
                                                            ...
                                                            String statusText = "paid".equals(status) ? "Đã thanh toán" :
                                                            "pending".equals(status) ? "Chưa thanh toán" : status;
                                                            %>
                                                            <div class="card-compact">
                                                                ...
                                                                <div class="mb-3 pb-3 border-bottom">
                                                                    <p class="mb-1"><small
                                                                            class="text-muted">Số tiền:</small></p>
                                                                ...
                                                                <div class="d-flex gap-2">
                                                                    ...
                                                                    <% if (PermissionUtil.hasPermission(session, "payments.delete" )) { %>
