            ...
            <div class="col-lg-3 col-md-4 mb-4">
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<%= request.getContextPath() %>/reports" class="active"><i class="bi bi-graph-up"></i> Reports</a></li>
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <p class="lead">Phân tích dữ liệu và tạo báo cáo chi tiết về hoạt động khách sạn</p>
                    </div>
                </div>
                                ...
                                if (bookings != null) {
                                    for (Map<String, Object> booking : bookings) {
                                        if (booking.get("total_amount") != null) {
                                            totalRevenue += Double.parseDouble(booking.get("total_amount").toString());
                                        }
                                    }
                                }
                                %>
