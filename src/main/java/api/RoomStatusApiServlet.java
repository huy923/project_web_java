...
@WebServlet(name = "RoomStatusApiServlet", urlPatterns = { "/api/room-status" })
public class RoomStatusApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<Map<String, Object>> roomStatus = dao.getCurrentRoomStatus();
            ...
            response.add("data", gson.toJsonTree(roomStatus));
